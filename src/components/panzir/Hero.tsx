      ...
      <div className="container relative z-10 pt-28 pb-16 md:pt-32 md:pb-20">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          <div className="flex w-[min(100vw-2rem,1180px)] items-center justify-center gap-[3vw] sm:gap-7">
            <span className="h-px w-[6vw] shrink-0 bg-gradient-to-r from-transparent to-garnet-bright sm:w-14 md:w-20" />
            <h1
            ...
            <span className="h-px w-[6vw] shrink-0 bg-gradient-to-l from-transparent to-garnet-bright sm:w-14 md:w-20" />
          </div>
