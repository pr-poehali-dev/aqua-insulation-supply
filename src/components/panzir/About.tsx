        ...
        <div className="grid items-stretch gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="flex flex-col lg:col-span-6">
            ...
            <div className="mt-8 space-y-6 text-lg leading-relaxed text-ink-muted">
              ...
              <p>
                Мы разрабатываем и производим на собственном производстве изделия
                тепло-, шумоизоляционные многоразового использования — ИТШМИ
                «ПАНЦИРЬ». Также поставляем комплексные решения по теплоизоляции,
                шумоизоляции и огнезащите для промышленных и гражданских
                объектов.
              </p>
              <p>
