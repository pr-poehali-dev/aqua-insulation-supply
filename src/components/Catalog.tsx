...
export default function Catalog({ searchQuery }: CatalogProps) {
  ...
  const products = [
    ...
    },
    {
      ...
      application: 'Трубопроводы, кондиционирование, холодоснабжение',
      icon: 'Waves',
      image: 'https://cdn.poehali.dev/projects/f1826e2b-819c-415e-ba4d-8aa7518a1625/files/fa16e012-d810-435f-b4a4-8dc24fc7958d.jpg',
    },
    {
      id: 3,
